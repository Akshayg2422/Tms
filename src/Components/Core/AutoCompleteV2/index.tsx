...
import { AutoCompleteV2Props } from './interfaces'
import { FormGroup } from 'reactstrap'
import { Option, InputHeading } from '@Components'

function AutoCompleteV2({ variant = 'default', data, id, heading, selected, className, onChange }: AutoCompleteV2Props) {
