...
function CollapseEnableButton({ title, children, displayDataSet, tableDataSet, tableOnClick, text, onClick, childrenS, selectedIds, selectedId, selectButton = true, taskStatus,
  selectButtonReject = false, textReject,
  onClickReject, ApprovedStatus ,textEnable,onClickEnable,enableButton=false,enableDataSet}: AuthContainerProps) {
...
//    {enableDataSet &&enableDataSet.map(()=>{
