        ...
        <HomeContainer>
            ...
            <Card className={'mx--3'} style={{ height: '58vh' }}>
                ...
                <div className="row align-items-center my-4">
                    ...
                    <div className="col"></div>
                    <div className="col">
                        <h6 className="text-uppercase d-flex justify-content-end">{getDisplayDateTimeFromMoment(getMomentObjFromServer(eta_time))}<span
                            onClick={() => { setEditEta(!editEta) }} className="bi bi-pencil mx-2"></span></h6>
                    </div>
                </div>
