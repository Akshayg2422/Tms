...
function TaskDetails() {
    ...
    const TABS = [
        {
            id: "1",
            title: <div className="text-center"><Image src={icons.Comments} height={16} width={16} /></div>,
            component: <Comments />
        },
        {
            id: "2",
            title: <div className="text-center"><Image src={icons.attachments} height={16} width={16} /></div>,
            component: <TaskAttachments />
        },
        {
            id: "3",
            title: <div className="text-center"><Image src={icons.reference} height={16} width={16} /></div>,
            component: <ReferenceTasks />
        },
        {
            id: "4",
            title: <div className="text-center"><Image src={icons.users} height={16} width={16} /></div>,
            component: <TaskUsers />
        },
    ];
