...
const TicketInfo = ({ onClick }: TicketInfoProps, ref: any) => {
  ...
  const { ticketDetails, selectedTicket } = useSelector(
...
(
      ...
      <Modal
        size={"md"}
        title={translate("auth.EditTicketDetails")!}
        isOpen={editTicketModal.visible}
        onClose={editTicketModal.hide}
      >
        <Input
          type={"text"}
      ...
      >
        <div className="col-6">
          ...
          <DateTimePicker
            heading={"ETA"}
            initialValue={getDisplayDateTimeFromMoment(
      ...
      <Modal
        ...
        size={"lg"}
        isOpen={ticketEventModal.visible}
        onClose={ticketEventModal.hide}
      >
        <TicketEventHistory />
      </Modal>
