    ...
    <div id='screen2'></div>
      <div className='row mt-sm-0 mt-6 mt-lg-8 mt-md-6 m-0'>
        <h1 className={'text-default secondHeading display-2'}>
          {translate('gate.secondScreen.accurateBillingCustomerSatisfaction')}
        </h1>


        <p className={'text-default mt-2 subText mb-4  h2 font-weight-light'}>
          {translate('gate.secondScreen.subText')}
        </p>
      ...
      <div className={'row ml-lg--3 ml-md--3 mt-md-4'}>
        <div className='col-lg-6'>
          <Image
            src={image.QrcodeMachine}
            alt={'frame image'}
            width={'100%'}
            height={'100%'}
          />
        </div>
        <div className='col-lg-6 mt-lg-0 mt-sm-0 mt-4 mt-md-5'>
          <Image
            src={image.parking}
            alt={'Sname image'}
            width={'100%'}
