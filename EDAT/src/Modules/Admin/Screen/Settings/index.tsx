    ...
    return (
        <>
            ...
            */}
                ...
                <Modal isModalLoading={postAddingDepartmentLoader.loader} isOpen={isDepartmentModal} onClose={() => setIsDepartmentModal(!isDepartmentModal)} title={translate('course.addCourse')!} >
                    <div className="">
                        <Input
            ...
            */}
                ...
                <Modal isModalLoading={postAddingDesignationLoader.loader} isOpen={isDesignationModal} onClose={() => setIsDesignationModal(!isDesignationModal)} title={translate('course.addFacultyRole')!}>
                    <div className="">
                        <Input
