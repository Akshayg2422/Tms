        ...
        dispatch(
          otpLogin({
            ...
            onSuccess: response => {
              ...
              showToast('success','User Validated Successfully')
              ...
              dispatch(
                userLoginDetails({
                  ...
                  is_faculty: response.details?.is_faculty,
                  employee_id: response.details?.employee_id,
                  name:response.details?.name,
                  photo:response.details?.photo
                }),
              );
